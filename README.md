...
The was added because if an attacker is able to infiltrate the honeypot virtual machine they will not be able to move laterally through the network. All of the rules that are configured for the nsg-internal should look as follows.
